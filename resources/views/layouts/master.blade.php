...
<html lang="en" dir="ltr">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>i</b>Stock</span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li>
                <a href="#" role="button" class="view-mode-button" aria-label="vista de lista" data-view="list">
                  <img src="{{ asset('images/icons/view_column.svg') }}" alt="" style="height: 20px;">
                </a>
              </li>
    ...
    <!-- jQuery 3 -->
    <script src="{{ asset('components/jquery/dist/jquery.min.js') }}"charset="utf-8" ></script>
    <!-- jQuery UI 1.11.4 -->
    <script src="{{ asset('components/jquery-ui/jquery-ui.min.js')}}" charset="utf-8"></script>
    <!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->

    <!-- Bootstrap WYSIHTML5 -->
    <script src="{{ asset('components/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>

    <script src="{{ asset('components/bootstrap/js/bootstrap.min.js') }}" charset="utf-8"></script>
